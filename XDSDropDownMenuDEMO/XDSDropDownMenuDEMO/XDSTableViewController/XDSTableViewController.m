...
@interface XDSTableViewController ()<XDSDropDownMenuDelegate>
...
@implementation XDSTableViewController{
...
- (void)setArrays{
    ...
    self.buttonArray = @[self.nameButton,self.sexButton,self.downButton,self.upButton];
    ...
    self.dropDownMenuArray = @[nameDropDownMenu,sexDropDownMenu,downDropDownMenu,upDropDownMenu];
